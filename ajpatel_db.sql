...
CREATE TABLE `ajpatel_invoice` (
  ...
  `invoice_owner_company` varchar(255) NOT NULL,
  ...
  `invoice_total_cgst` varchar(255) NOT NULL,
  `invoice_total_sgst` varchar(255) NOT NULL,
  `invoice_total_igst` varchar(255) NOT NULL,
  `invoice_rs_in_word` varchar(255) NOT NULL,
...
-- INSERT INTO `ajpatel_invoice` (`invoice_id`, `invoice_number`, `invoice_owner_company`, `invoice_owner_name`, `invoice_owner_mobile`, `invoice_owner_email`, `invoice_owner_address`, `invoice_owner_city`, `invoice_owner_state`, `invoice_owner_pincode`, `invoice_owner_gstin`, `invoice_owner_pan_no`, `invoice_party_id`, `invoice_party_name`, `invoice_party_contact_person`, `invoice_party_mobile`, `invoice_party_address`, `invoice_party_city`, `invoice_party_state`, `invoice_party_pincode`, `invoice_party_gstin`, `invoice_party_pan_no`, `invoice_date`, `invoice_truck_no`, `invoice_transport`, `invoice_l_r_no`, `invoice_delivery_note`, `invoice_round_of_on_total`, `invoice_total`, `invoice_sub_total`, `invoice_total_cgst`, `invoice_total_sgst`, `invoice_total_igst`, `invoice_rs_in_word`, `invoice_bank_name`, `invoice_bank_ac_no`, `invoice_bank_branch`, `invoice_bank_ifsc`, `invoice_is_challan`, `invoice_pdf`, `invoice_status`, `invoice_add_by`, `invoice_modify_by`, `invoice_add_date`, `invoice_modify_date`) VALUES
-- (2, '0001', 'XYZ', 'Admin', '9898989898', '', 'Naroda', 'ahmedabad', 'gujarat', '382330', '24AMIT101991INEX', '24101991', 3, 'Budh Saw Mill', 'Budhdha', '654654', 'Budhpur', 'Badrinath', 'Bombay', '987654', 'bbbb111bb11', 'b1b1b1b1b1', '1501632000', 'GJ01MW0414', 'Amit Transport', '654321', '', '300', 18000.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', '', 'Active', 1, NULL, '1501695497', ''),
-- (3, '0002', 'XYZ', 'Admin', '9898989898', 'amit2410ip@gmail.com', 'Naroda', 'ahmedabad', 'gujarat', '382330', '24AMIT101991INEX', '24101991', 2, 'Mangal Saw Mill', 'Mangal das', '456456456', 'Unja', 'Mahesana', 'Gujarat', '98654', 'qwerty123456', 'poiuyt321321', '1501891200', 'GJ01MW0414', 'Amit Transport', '654321', '', '40', 5200.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', '', 'Active', 1, NULL, '1501964293', ''),
-- (4, '0002', 'XYZ', 'Admin', '9898989898', 'amit2410ip@gmail.com', 'Naroda', 'ahmedabad', 'gujarat', '382330', '24AMIT101991INEX', '24101991', 2, 'Mangal Saw Mill', 'Mangal das', '456456456', 'Unja', 'Mahesana', 'Gujarat', '98654', 'qwerty123456', 'poiuyt321321', '1501891200', 'GJ01MW0414', 'Amit Transport', '654321', '', '40', 5200.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', 'invc_1501964357.pdf', 'Active', 1, NULL, '1501964357', ''),
-- (5, '5001', 'XYZ', 'Admin', '9898989898', 'amit2410ip@gmail.com', 'Naroda', 'ahmedabad', 'gujarat', '382330', '24AMIT101991INEX', '24101991', 4, 'Galaxy mica pvt ltd', 'Himashu |Patel', '9876543210', 'Ujadiya', 'Gandhinagar', 'Gujarat', '654321', 'ABCDE123456789', 'XYZ123456', '1504224000', 'GJ01MW0414', 'XYZ transtort', '654321', '', '200', 38000.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', 'invc_1504511529.pdf', 'Active', 1, NULL, '1504511524', ''),
-- (6, '1001', 'XYZ', 'Admin', '9898989898', 'admin@gmail.com', 'naroda', 'ahmedabad', 'Gujarat', '543211', 'AJ123XYZ123123', 'ABCD12OMN', 5, 'Mahadev Timber1', 'Shivbhai1', '9876543211', 'Kailash1', 'Himalaya1', 'Jammu1', '6543211', 'gst1231', 'pan1231', '1520121600', 'GJ01MH1234', 'Ganesh Transport', '1234', '', '20', 14140.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', '', 'Active', 1, NULL, '1522826962', ''),
-- (7, '1001', 'XYZ', 'Admin', '9898989898', 'admin@gmail.com', 'naroda', 'ahmedabad', 'Gujarat', '543211', 'AJ123XYZ123123', 'ABCD12OMN', 5, 'Mahadev Timber1', 'Shivbhai1', '9876543211', 'Kailash1', 'Himalaya1', 'Jammu1', '6543211', 'gst1231', 'pan1231', '1520121600', 'GJ01MH1234', 'Ganesh Transport', '1234', '', '20', 14140.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', '', 'Active', 1, NULL, '1522827269', ''),
-- (8, '1001', 'XYZ', 'Admin', '9898989898', 'admin@gmail.com', 'naroda', 'ahmedabad', 'Gujarat', '543211', 'AJ123XYZ123123', 'ABCD12OMN', 5, 'Mahadev Timber1', 'Shivbhai1', '9876543211', 'Kailash1', 'Himalaya1', 'Jammu1', '6543211', 'gst1231', 'pan1231', '1520121600', 'GJ01MH1234', 'Ganesh Transport', '1234', '', '20', 14140.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', '', 'Active', 1, NULL, '1522827450', ''),
-- (9, '1001', 'XYZ', 'Admin', '9898989898', 'admin@gmail.com', 'naroda', 'ahmedabad', 'Gujarat', '543211', 'AJ123XYZ123123', 'ABCD12OMN', 5, 'Mahadev Timber1', 'Shivbhai1', '9876543211', 'Kailash1', 'Himalaya1', 'Jammu1', '6543211', 'gst1231', 'pan1231', '1520121600', 'GJ01MH1234', 'Ganesh Transport', '1234', '', '20', 14140.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', '', 'Active', 1, NULL, '1522827487', ''),
-- (10, '1001', 'XYZ', 'Admin', '9898989898', 'admin@gmail.com', 'naroda', 'ahmedabad', 'Gujarat', '543211', 'AJ123XYZ123123', 'ABCD12OMN', 5, 'Mahadev Timber1', 'Shivbhai1', '9876543211', 'Kailash1', 'Himalaya1', 'Jammu1', '6543211', 'gst1231', 'pan1231', '1520121600', 'GJ01MH1234', 'Ganesh Transport', '1234', '', '20', 14140.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', '', 'Active', 1, NULL, '1522827510', ''),
-- (11, '1001', 'XYZ', 'Admin', '9898989898', 'admin@gmail.com', 'naroda', 'ahmedabad', 'Gujarat', '543211', 'AJ123XYZ123123', 'ABCD12OMN', 5, 'Mahadev Timber1', 'Shivbhai1', '9876543211', 'Kailash1', 'Himalaya1', 'Jammu1', '6543211', 'gst1231', 'pan1231', '1520121600', 'GJ01MH1234', 'Ganesh Transport', '1234', '', '20', 14140.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', '', 'Active', 1, NULL, '1522827550', ''),
-- (12, '1001', 'XYZ', 'Admin', '9898989898', 'admin@gmail.com', 'naroda', 'ahmedabad', 'Gujarat', '543211', 'AJ123XYZ123123', 'ABCD12OMN', 5, 'Mahadev Timber1', 'Shivbhai1', '9876543211', 'Kailash1', 'Himalaya1', 'Jammu1', '6543211', 'gst1231', 'pan1231', '1520121600', 'GJ01MH1234', 'Ganesh Transport', '1234', '', '20', 14140.00, 38000.00, '123', '123', '123', 'one rupee', '', '', '', '', 'No', '', 'Active', 1, NULL, '1522833046', '');
...
CREATE TABLE `ajpatel_invoice_item` (
  ...
  `ii_amount` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- INSERT INTO `ajpatel_invoice_item` (`ii_id`, `ii_invoice_id`, `ii_product_name`, `ii_hsn_no`, `ii_rate`, `ii_qnt`, `ii_unit`, `ii_cgst`, `ii_sgst`, `ii_igst`, `ii_amount`) VALUES
...
(1, '123', 'AJPatel', 'Admin', 'ajpatel', 'ajpatel', '$2y$10$YQ8osKam.W6DWzbAksUfaO8wSHV0.RA8MFMXM3jeQbtfV0T/TzMUa', 'A. J. Patel & Co.', 'Timber Merchant & Commission Agent', '', 'B/H. Kutch Kadwa Patidar Samajvadi, Naroda Road, Naroda', 'Ahmedabad', 'Gujarat', '382340', '24AAEFA7517L1ZF', '', 'Active', '', NULL, '', '1522701900');
